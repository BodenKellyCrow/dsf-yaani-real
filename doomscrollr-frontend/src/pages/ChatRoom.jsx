...
const ChatRoom = () => {
    ...
    const fetchMessages = async () => {
        try {
            // ✅ FIX 2: Correct URL path matches projects/urls.py
    ...
    const sendMessage = async (e) => {
        ...
        try {
            // ✅ FIX 3: Clean payload
            // Backend's MessageListCreateView automatically sets 'sender' and gets 'conversation' from the URL
            const payload = {
                text: text.trim(),
            };
            ...
            const errorMsg = err.response?.data?.text?.[0] || 'Unknown error';
    ...
    // ✅ Get username from localStorage for display/identification
        ...
        <div className="max-w-3xl mx-auto p-6 h-screen flex flex-col">
            ...
            <form onSubmit={sendMessage} className="flex gap-3 items-center">
                <input
                    ...
                    // Added onKeyPress for better UX, though form submit also works
